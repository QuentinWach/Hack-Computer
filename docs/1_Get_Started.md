...
>iverilog
```
which will just print out some text in your terminal. [This video] might be of great help to you. It really is that simple. The whole ecosystem simply has terrible, terrible documentation.
...
This module simply prints out the classic "Hello World!".
